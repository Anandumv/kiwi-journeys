...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const now = new Date();
  const staticPaths = ["", "/tours", "/destinations", "/about", "/sustainability", "/contact", "/cruise-excursions", "/travel-insights", "/privacy-policy", "/terms-of-use", "/faq", "/private-tours", "/gift-vouchers"];
  ...
  const priorities: Record<string, number> = { "": 1.0, "/tours": 0.9, "/destinations": 0.8, "/cruise-excursions": 0.75, "/private-tours": 0.7, "/gift-vouchers": 0.6, "/about": 0.6, "/contact": 0.6, "/travel-insights": 0.6, "/faq": 0.5, "/sustainability": 0.4, "/privacy-policy": 0.2, "/terms-of-use": 0.2 };

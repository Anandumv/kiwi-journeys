...
export const tours: Tour[] = [
  ...
  },
  {
    ...
    optionalUpgrades: ["Dark Sky Experience", "Hot pools", "Mt John Observatory tour"],
    priceOptions: [
  ...
  },
  {
    ...
    included: ["Driver / Guide", "Hotel pickup and drop-off"],
    optionalUpgrades: ["Whale Watch cruise", "Dolphin Encounter swim", "Albatross Encounter tour"],
    priceOptions: [
      { key: "adult", label: "Adult", priceCents: 19900, seatsPerUnit: 1 },

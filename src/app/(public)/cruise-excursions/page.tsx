...
export const metadata: Metadata = {
  ...
  description: "Shore excursions timed around your ship's schedule. Small groups, expert guides, Lyttelton and Akaroa, New Zealand.",
  alternates: { canonical: `${SITE_URL}/cruise-excursions` },
  openGraph: {
    title: "Cruise Shore Excursions — Lyttelton & Akaroa | Kiwi Globe Tours",
    description: "Shore excursions timed around your ship's schedule. ",
  ...
  twitter: { card: "summary_large_image", title: "Cruise Shore Excursions | Kiwi Globe Tours", description: "Shore excursions timed around your ship's schedule. " },
};
...
export default async function CruisePage() {
  ...
  const serviceLd = {
    ...
    description: "Shore excursions designed for cruise passengers calling at Lyttelton and Akaroa, New Zealand. Port-timed tours with return planned around the ship schedule.",
    url: `${SITE_URL}/cruise-excursions`,
  ...
  return (
    <>
      ...
      <PageHero title="Cruise Shore Excursions" subtitle="Plan a day ashore around your ship’s port call." image="/images/tours/akaroa-day-tour/7395a4_1eeaa091aa3b4f77b03d91a41ae8743e-mv2_4.jpg"
        caption="Akaroa Harbour"
      />
      <section className="mx-auto max-w-3xl px-4 py-12 sm:px-6 text-foreground/80 leading-relaxed">
        <p>
          ...
          schedule, with pickup and return timed for your ship. Explore Christchurch, swim
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 sm:px-6">
        <h2 className="font-serif text-3xl font-semibold text-foreground">Popular with cruise guests</h2>

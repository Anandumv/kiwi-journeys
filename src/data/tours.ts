...
export const tours: Tour[] = [
  ...
  },
  {
    ...
    optionalUpgrades: ["Waiau Gorge jet boat ride", "Spa pools / private pool upgrade"],
    priceOptions: [
  ...
  {
    slug: "arthurs-pass-tranzalpine",
    code: "LT06A",
    title: "Arthur's Pass Day Tour with TranzAlpine Train",
    destination: "Arthur's Pass",
    category: "iconic-day-trips",
    durationLabel: "1 Day",
    durationMins: 600,
    ageRange: "All Ages",
    startEnd: "Christchurch → Christchurch",
    pickup: "Pick up from your central city accommodation in the morning",
    summary:
      "A great train ride matched with an alpine road tour — ride the TranzAlpine across the Southern Alps, spend time in Arthur's Pass National Park, and loop home through Canterbury's high country.",
    priceFromCents: 49500,
    heroImage: img("arthurs-pass-tranzalpine", "tranzalpine.jpg"),
    gallery: ["tranzalpine.jpg", "arthurs-pass-alps.jpg", "scenery.jpg"].map((f) =>
      img("arthurs-pass-tranzalpine", f),
    ),
    highlights: [
      "A ride on the TranzAlpine, regularly rated among the world's most scenic rail trips",
      "Beech forest, river flats and deep gorges as the line climbs the Southern Alps",
      "Time in the alpine village and national park at Arthur's Pass",
      "Big views over the braided Waimakariri and the Canterbury high country",
    ],
    itinerary: [
      "From Christchurch you board the TranzAlpine and climb out of the plains into the mountains, tracing the braided Waimakariri past gorges and viaducts.",
      "At Arthur's Pass — New Zealand's highest village and the gateway to the national park — there's time to take in the peaks and keep an eye out for cheeky native kea.",
      "We bring you back over the alps by road with commentary along the way, reaching Christchurch in the late afternoon for a drop-off at your accommodation.",
    ],
    included: ["TranzAlpine train ticket", "Driver / Guide", "Hotel pickup and drop-off"],
    priceOptions: [
      { key: "adult", label: "Adult", priceCents: 49500, seatsPerUnit: 1 },
      { key: "child", label: "Child (5–14)", priceCents: 34500, seatsPerUnit: 1 },
    ],

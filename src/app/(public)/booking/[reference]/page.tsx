    ...
    <div className="mx-auto max-w-2xl px-4 py-14 sm:px-6">
      <div className="rounded-2xl border border-brand-100 bg-white p-8 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-brand-900">{booking.status === "CONFIRMED" ? "Booking confirmed!" : booking.status === "REFUNDED" ? "Booking refunded" : "Booking cancelled"}</h1>
